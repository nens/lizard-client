...
.service('temporalWmsLayer', [
  ...
  '$q',
  "State",
  function (LeafletService, RasterService, UtilService, $http, $q, State) {
  ...
  var temporalWmsLayer = LeafletService.Class.extend({
    ...
    initialize: function (options) {
      ...
      Object.defineProperty(this.layer, '_imageOverlays', {
        value: [],
        writable: true,
      });
      // Formatter used to format a data object.
      Object.defineProperty(this.layer, '_formatter', {
        value: d3.time.format.utc("%Y-%m-%dT%H:%M:%S"),
        writable: true,
      });
      // Base of the image url without the time.
      Object.defineProperty(this.layer, '_imageUrlBase', {
        value: '',
        writable: true,
      });
      // Lookup to store which data correspond to which imageOverlay.
      Object.defineProperty(this.layer, '_frameLookup', {
        value: {},
        writable: true,
      });
      ...
      // for a big buffer.
      Object.defineProperty(this.layer, '_bufferLength', {
        value: this.layer._temporalResolution >= 3600000 ? 2 : 6,
        writable: true,
      });
      // Number of rasters currently underway.
      Object.defineProperty(this.layer, '_nLoadingRasters', {
        value: 0,
        writable: true,
      });
    ...
    onAdd: function (map) {
      ...
      options = angular.extend(options, this.layer.options);
      ...
      this._imageOverlays = [
        LeafletService.tileLayer.wms(this.layer.url, options)
      ];
    ...
    /**
     * syncToTime with a tiled layer. Removes everything and uses
    ...
    _determineStore: function (timeState) {
      ...
      if (this.slug.split('/')[0] !== 'radar') {
        return {
          ...
          resolution: this.layer._temporalResolution
        };
      }
