      ...
      link: function(scope, element) {
        ...
        var setAsset = function(asset) {
          ...
          if (asset.geometry) {
            ...
            clickId = ClickFeedbackService.drawGeometry(MapService, feature);
...
angular.module("omnibox").directive("geometryCards", [
  "MapService",
  "ClickFeedbackService",
  "CSVService",
  "user",
      ...
      link: function(scope, element) {
        ...
        scope.$watchCollection("geom.geometry.coordinates", function() {
          ...
          if (scope.header && geom.geometry.type === "Point") {
            ...
            clickId = ClickFeedbackService.drawLine(MapService, start, end);
          }
        });
...
angular.module("omnibox").directive("cardattributes", [
  "WantedAttributes",
...
angular.module("omnibox").directive("cardheader", [
  "UtilService",
...
angular.module("omnibox").directive("summaryCard", [
  "WantedAttributes",
  function(WantedAttributes) {
    return {
      link: function(scope) {
...
angular.module("omnibox").directive("nestedasset", [
  "WantedAttributes",
  "DataService",
  "State",
  "getNestedAssets",
       ...
       */
        ...
        scope.selectedAssetChanged = function(newAsset) {
          scope.list.forEach(function(asset) {
            if (
              asset.entity_name === newAsset.entity_name &&
...
angular.module("omnibox").directive("rain", [
  "State",
  "RasterService",
  "UtilService",
...
angular.module("omnibox").directive("defaultpoint", [
  "UtilService",
  function(UtilService) {
    return {
      link: function(scope) {
...
angular.module("omnibox").directive("searchResults", [
  function() {
    return {
      restrict: "E",
