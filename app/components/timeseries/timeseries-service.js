...
.service("TimeseriesService", [
  ...
  'gettextCatalog',
  function ($q, State, $http, notie, UtilService, DataService, TsUService, RTSLService, gettextCatalog) {
    ...
    var errorFn = function (err) {
      if (err.status === 420 || err.status === -1) {
        ...
        notie.alert(3, gettextCatalog.getString('Lizard encountered a problem retrieving your timeseries.'), 3);
        // Cancel normal operations
        return $q.reject(err);
      }
