...
angular.module('templates-main', ['annotations/templates/annotations-make.html', 'annotations/templates/annotations-view.html', 'annotations/templates/annotations.html', 'dashboard/dashboard.html', 'data-menu/data-menu-item.html', 'data-menu/data-menu.html', 'graph/graph.html', 'layer-chooser/baselayer-chooser.html', 'layer-chooser/eventlayer-chooser.html', 'layer-chooser/layer-chooser.html', 'omnibox/templates/area.html', 'omnibox/templates/card-header.html', 'omnibox/templates/cardattributes.html', 'omnibox/templates/dashboard-cards.html', 'omnibox/templates/db-asset-card.html', 'omnibox/templates/defaultpoint.html', 'omnibox/templates/empty.html', 'omnibox/templates/full-details.html', 'omnibox/templates/line.html', 'omnibox/templates/multi-point.html', 'omnibox/templates/nestedasset.html', 'omnibox/templates/omnibox-search.html', 'omnibox/templates/point.html', 'omnibox/templates/rain.html', 'omnibox/templates/region.html', 'omnibox/templates/search-results.html', 'omnibox/templates/search.html', 'omnibox/templates/summary-card.html', 'opacity/opacity.html', 'scenarios/scenarios.html', 'timeline/timeline.html', 'timeseries/timeseries.html', 'user-menu/user-menu.html']);
...
angular.module("annotations/templates/annotations.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("annotations/templates/annotations.html",
    ...
    "    <annotations-make\n" +
    "      ng-class=\"{ hidden: !fullDetails }\"\n" +
    "      ng-if=\"box.content.waterchain.layers.waterchain_grid.data\"\n" +
    "      asset=\"box.content.waterchain.layers.waterchain_grid.data\"\n" +
    "      timelineat=\"timeline.state.temporal.at\"\n" +
    "      annotations=\"annotations\">\n" +
    "    </annotations-make>\n" +
    "  </div>\n" +
    "</div>\n" +
...
angular.module("omnibox/templates/card-header.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("omnibox/templates/card-header.html",
    ...
    "    <full-details class=\"pull-right\"></full-details>\n" +
    "\n" +
...
angular.module("omnibox/templates/cardattributes.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("omnibox/templates/cardattributes.html",
    "<div>\n" +
    "\n" +
    "  <cardheader asset=\"waterchain.layers.waterchain_grid.data\"></cardheader>\n" +
    "\n" +
...
angular.module("omnibox/templates/multi-point.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("omnibox/templates/multi-point.html",
    "<div ng-controller=\"MultiPointCtrl\">\n" +
    "  <div ng-if=\"box.content.assets\">\n" +
    "    <div class=\"card card-active\" ng-repeat=\"asset in box.content.assets\">\n" +
    "      <summary-card asset=\"asset\"></summary-card>\n" +
    "    </div>\n" +
    "  </div>\n" +
    "\n" +
    "</div>\n" +
...
angular.module("omnibox/templates/search-results.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("omnibox/templates/search-results.html",
    ...
    "\n" +
    "  <h3 ng-if=\"box.content.searchResults.spatial.length > 0\">\n" +
    "    <i class=\"fa fa-map-marker\">&nbsp;</i>\n" +
    "    <span translate>Locations</span>&nbsp;(<% box.content.searchResults.spatial.length %>)\n" +
    "  </h3>\n" +
    "  <ul>\n" +
    "    <li ng-cloak\n" +
    ...
    "  </ul>\n" +
    "\n" +
    "  <h3 ng-if=\"box.content.searchResults.timeseries.length > 0\">\n" +
    "    <i class=\"fa fa-clock-o\">&nbsp;</i>\n" +
    "    <span translate>Timeseries</span>&nbsp;(<% box.content.searchResults.timeseries.length %>)\n" +
    "  </h3>\n" +
    "  <ul>\n" +
    "    <li ng-cloak\n" +
    "      ng-repeat=\"result in box.content.searchResults.timeseries\"\n" +
    "      class=\"cluster location\">\n" +
    ...
    "  </ul>\n" +
    "\n" +
    "  <h3 ng-if=\"box.content.searchResults.layergroups.length > 0\">\n" +
    "    <i class=\"fa fa-clock-o\">&nbsp;</i>\n" +
    "    <span translate>Map</span>&nbsp;(<% box.content.searchResults.layergroups.length %>)\n" +
    "  </h3>\n" +
    "  <ul>\n" +
    "    <li ng-cloak\n" +
    "      ng-repeat=\"result in box.content.searchResults.layergroups\"\n" +
    "      class=\"cluster location\">\n" +
    ...
    "  </ul>\n" +
    "\n" +
    "  <h3 ng-if=\"box.content.searchResults.temporal.length > 0\" translate>Time</h3>\n" +
    "	<div\n" +
...
angular.module("timeline/timeline.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("timeline/timeline.html",
    ...
    "           title=\"<% timelineVisible ? tooltips.closeTimeline : tooltips.openTimeline %>\">\n" +
    "        </div>\n" +
    ...
    "            <i class=\"fa\" ng-class=\"{\n" +
    "              'fa-minus-square': timeline.state.context === 'dashboard',\n" +
...
angular.module("user-menu/user-menu.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("user-menu/user-menu.html",
    ...
    "\n" +
    "    <a ng-if=\"!user.authenticated\"\n" +
    "       onclick=\"logIn()\" title=\"<% tooltips.login %>\"\n" +
    "      class=\"clickable\" >\n" +
    ...
    "\n" +
    "  <nav>\n" +
    "    <a class=\"hidden-xs material-shadow\" ng-click=\"toggleDashboard()\" title=\"<% 'Switch to ' + context | translate %>\" target=\"_blank\">\n" +
    "      <i class=\"fa fa-refresh\"></i>\n" +
    "    </a>\n" +
    "    <a class=\"hidden-xs material-shadow\" href=\"https://www.lizard.net/support\" title=\"<% 'Question and manual' | translate %>\" target=\"_blank\">\n" +
