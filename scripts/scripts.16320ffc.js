...
/* jshint -W100 */
    gettextCatalog.setStrings('en', {"<% getcontextcomplement()=\"\" %=\"\"></%>":"<% getcontextcomplement()=\"\" %=\"\"></%>","<% result.result_type.name=\"\" %=\"\"></%>":"<% result.result_type.name=\"\" %=\"\"></%>","<% state.baselayer=\"\" |=\"\" translate=\"\" capitalize=\"\" %=\"\"></%>":"<% state.baselayer=\"\" |=\"\" translate=\"\" capitalize=\"\" %=\"\"></%>","<span translate=\"\">Statistics</span>":"<span translate=\"\">Statistics</span>","Add an annotation":"Add an annotation","Add an attachment:":"Add an attachment:","Add data…\n          <div class=\"layer-chooser-tools\">\n            <i class=\"fa fa-plus\"></i>\n          </div>":"Add data&hellip;\n          <div class=\"layer-chooser-tools\">\n            <i class=\"fa fa-plus\"></i>\n          </div>","Address":"Address","Adjust opacity":"Adjust opacity","Annotation attachment size cannot be bigger than 10MB.":"Annotation attachment size cannot be bigger than 10MB.","Annotation message...":"Annotation message...","Annotation text cannot be longer than 256 characters.":"Annotation text cannot be longer than 256 characters.","Annotation text is required.":"Annotation text is required.","Annotations":"Annotations","Aquifer confinement":"Aquifer confinement","Archive Message":"Archive Message","Are you sure you want to delete this annotation?":"Are you sure you want to delete this annotation?","Are you sure you want to log out?":"Are you sure you want to log out?","Assets":"Assets","Ay ay: Lizard could not retrieve your favourite":"Ay ay: Lizard could not retrieve your favourite","Baselayer":"Baselayer","Bosom channel":"Bosom channel","Bottom level":"Bottom level","Bottom level manhole":"Bottom level manhole","Bridge":"Bridge","Building":"Building","Capacity":"Capacity","Category":"Category","Channel":"Channel","City":"City","Close data menu":"Close data menu","Close result window":"Close result window","Close timeline":"Close timeline","Coating":"Coating","Code":"Code","Connected impervious surface":"Connected impervious surface","Construction year":"Construction year","Control":"Control","Crest Level":"Crest Level","Crest height":"Crest height","Crest level":"Crest level","Crest width":"Crest width","Crossprofile":"Crossprofile","Culvert":"Culvert","Dashed line":"Dashed line","Delete this annotation from the database.":"Delete this annotation from the database.","Diameter":"Diameter","Distance along cross section":"Distance along cross section","Double click for lizard version number":"Double click for lizard version number","Down stream area":"Down stream area","Download":"Download","Download attachment.":"Download attachment.","Duration":"Duration","Edit profile":"Edit profile","Elevation along crosssection (source: AHN2).":"Elevation along crosssection (source: AHN2).","End":"End","End (simulation time)":"End (simulation time)","End of current timeline":"End of current timeline","Example value":"Example value","Export":"Export","Export all selected timeseries":"Export all selected timeseries","Export data":"Export data","Export info card data":"Export info card data","Export timeseries":"Export timeseries","Extraneous water":"Extraneous water","Favourite name cannot be longer than 256 characters.":"Favourite name cannot be longer than 256 characters.","Favourite name is required.":"Favourite name is required.","Favourites":"Favourites","Filter":"Filter","Filter bottom level":"Filter bottom level","Filter top level":"Filter top level","Frequency":"Frequency","Function":"Function","Go to modelbank":"Go to modelbank","Go to the present in timeline":"Go to the present in timeline","Green line":"Green line","Grey dots":"Grey dots","Groundwater station":"Groundwater station","Height":"Height","Help":"Help","Inhabitants":"Inhabitants","Invert level end point":"Invert level end point","Invert level start point":"Invert level start point","Layer could not be added":"Layer could not be added","Length":"Length","Levee":"Levee","Levee cross section":"Levee cross section","Levee reference point":"Levee reference point","Line selection":"Line selection","Litology":"Litology","Locations":"Locations","Log in":"Log in","Log out":"Log out","Make time relative (sticky to the end)":"Make time relative (sticky to the end)","Manhole":"Manhole","Manhole id":"Manhole id","Material":"Material","Measured hydraulic head at current time.":"Measured hydraulic head at current time.","Measuring station":"Measuring station","Messages <span class=\"badge\" ng-bind=\"inbox.length\"></span>":"Messages <span class=\"badge\" ng-bind=\"inbox.length\"></span>","Minimum overflow crest level":"Minimum overflow crest level","Model:":"Model:","Modify profile":"Modify profile","Monitoring well":"Monitoring well","Name":"Name","Never mind":"Never mind","New favourite name...":"New favourite name...","No":"No","No data available for this location":"No data available for this location","No raster data available for this geometry":"No raster data available for this geometry","No timeseries available for this asset":"No timeseries available for this asset","One annotation":["One annotation","<% $count %> annotations"],"Oops! Something went wrong while creating the annotation.":"Oops! Something went wrong while creating the annotation.","Oops! Something went wrong while creating the favourite.":"Oops! Something went wrong while creating the favourite.","Oops! Something went wrong while deleting the annotation.":"Oops! Something went wrong while deleting the annotation.","Oops! Something went wrong while deleting the favourite.":"Oops! Something went wrong while deleting the favourite.","Oops! Something went wrong while fetching the favourites.":"Oops! Something went wrong while fetching the favourites.","Oops! Something went wrong while fetching the layers.":"Oops! Something went wrong while fetching the layers.","Oops! Something went wrong while fetching your organisations.":"Oops! Something went wrong while fetching your organisations.","Open data menu":"Open data menu","Open timeline":"Open timeline","Open water level (average)":"Open water level (average)","Orifice":"Orifice","Outlet":"Outlet","Overflow":"Overflow","Pick the date range:":"Pick the date range:","Pipe":"Pipe","Play/pause":"Play/pause","Point selection":"Point selection","Pollution equivalent":"Pollution equivalent","Population equivalent":"Population equivalent","Pressure pipe":"Pressure pipe","Primary channel":"Primary channel","Pump":"Pump","Pump station":"Pump station","Pump station capacity":"Pump station capacity","Pumped drainage area":"Pumped drainage area","Question and manual":"Question and manual","RT (years)":"RT (years)","Rain":"Rain","Rain recurrence statistics":"Rain recurrence statistics","Recurrence times (RT)":"Recurrence times (RT)","Region selection":"Region selection","Restoring favourite":"Restoring favourite","Road":"Road","Sanitary load":"Sanitary load","Screen view":"Screen view","Search for places, or dates (i.e. 23-10-2013)":"Search for places, or dates (i.e. 23-10-2013)","Select Multiple Points":"Select Multiple Points","Select an organisation:":"Select an organisation:","Shape":"Shape","Show Messages":"Show Messages","Sluice":"Sluice","Start":"Start","Start (simulation time)":"Start (simulation time)","Start Export":"Start Export","Start animation":"Start animation","Start level":"Start level","Start of current timeline":"Start of current timeline","Statistics":"Statistics","Stop animation":"Stop animation","Stop level":"Stop level","Surface level":"Surface level","The 'now' of the timeline":"The 'now' of the timeline","Time":"Time","Timeseries":"Timeseries","Top level":"Top level","Total:":"Total:","Type":"Type","Upstream load":"Upstream load","Use":"Use","View selection":"View selection","Wastewater treatment plant":"Wastewater treatment plant","Water consumption":"Water consumption","Water retention capacity":"Water retention capacity","We will let you know when your download is ready. You're welcome to\n      wait here, but we're not sure how long it will take to piece everything\n      together.":"We will let you know when your download is ready. You're welcome to\n      wait here, but we're not sure how long it will take to piece everything\n      together.","We're piecing stuff together, you can either wait\n        patiently or see if it's ready yourself by following\n        <a ng-href=\"<% taskInfo.url %>\" translate=\"\">this link</a>":"We're piecing stuff together, you can either wait\n        patiently or see if it's ready yourself by following\n        <a ng-href=\"<% taskInfo.url %>\" translate=\"\">this link</a>","Weir":"Weir","Well bottom level":"Well bottom level","Well top level":"Well top level","Whoops: favourite has been removed":"Whoops: favourite has been removed","Width":"Width","Yes":"Yes","You can select multiple time series to download. Once selected, press the\n      <i>\"Start Export\"</i> button and the exporter will fetch the time series\n      behind the scenes.":"You can select multiple time series to download. Once selected, press the\n      <i>\"Start Export\"</i> button and the exporter will fetch the time series\n      behind the scenes.","You don't have any favourites yet.<br>\nAdd the current portal state to your favourites!":"You don't have any favourites yet.<br>\nAdd the current portal state to your favourites!","You need to be logged in for this favourite, do you want to log in now?":"You need to be logged in for this favourite, do you want to log in now?","Zipcode":"Zipcode","Zoom in on the map":"Zoom in on the map","Zoom in on timeline":"Zoom in on timeline","Zoom out of timeline":"Zoom out of timeline","Zoom out on the map":"Zoom out on the map","download\n        <i class=\"fa fa-2x fa-download\"></i>":"download\n        <i class=\"fa fa-2x fa-download\"></i>","indicative interpolation of hydraulic head in the same aquifer.":"indicative interpolation of hydraulic head in the same aquifer.","mm":"mm","mm / 5 min":"mm / 5 min","mm / day":"mm / day","mm / hour":"mm / hour","mm / month":"mm / month","this link":"this link"});
    gettextCatalog.setStrings('nl', {"<% result.result_type.name=\"\" %=\"\"></%>":"<% result.result_type.name=\"\" %=\"\"></%>","<% state.baselayer=\"\" |=\"\" translate=\"\" capitalize=\"\" %=\"\"></%>":"<% state.baselayer=\"\" |=\"\" translate=\"\" capitalize=\"\" %=\"\"></%>","<span translate=\"\">Statistics</span>":"<span translate=\"\">Statistieken</span>","Add an annotation":"Voeg een annotatie toe","Add an attachment:":"Voeg een bijlage toe:","Add data…\n          <div class=\"layer-chooser-tools\">\n            <i class=\"fa fa-plus\"></i>\n          </div>":"Toevoegen&hellip;\n<div class=\"layer-chooser-tools\">\n<i class=\"fa fa-plus\"></i>\n</div>","Adjust opacity":"Transparantie aanpassen","Annotation attachment size cannot be bigger than 10MB.":"Bijlage van annotatie mag niet groter zijn dan 10MB.","Annotation message...":"Annotatie bericht...","Annotation text cannot be longer than 256 characters.":"Annotatie mag niet langer zijn dan 256 tekens.","Annotation text is required.":"Annotatietekst is vereist.","Annotations":"Annotaties","Aquifer confinement":"Watervoerend pakket","Archive Message":"Archiveer bericht","Are you sure you want to delete this annotation?":"Weet u zeker dat u deze annotatie wilt verwijderen?","Are you sure you want to log out?":"Weet u zeker dat u uit wilt loggen?","Assets":"Assets","Ay ay: Lizard could not retrieve your favourite":"Bliksems: Lizard kon je favoriet niet laden","Baselayer":"Basislaag","Bosom channel":"Boezemkanaal","Bottom level":"Onderkant buis","Bottom level manhole":"Putbodem","Bridge":"Brug","Capacity":"Capaciteit","Category":"Categorie","Channel":"Watergang","Close data menu":"Sluit het datamenu","Close result window":"Sluit het resultatenvenster","Close timeline":"Sluit de tijdlijn","Coating":"Bekleding","Code":"Code","Connected impervious surface":"Aangesloten verhard oppervlak","Construction year":"Bouwjaar","Control":"Bediening","Crest Level":"Niveau","Crest height":"Kruinhoogte","Crest level":"Overstorthoogte","Crest width":"Overstortbreedte","Crossprofile":"Dwarsprofiel","Culvert":"Duiker","Dashed line":"Stippellijn","Delete this annotation from the database.":"Verwijder deze annotatie uit de database.","Diameter":"Diameter","Distance along cross section":"Afstand langs dwarsdoorsnede","Double click for lizard version number":"Dubbelklikken voor lizard versienummer","Down stream area":"Benedenstrooms gebied","Download":"Download","Download attachment.":"Bijlage downloaden.","Duration":"Duur","Edit profile":"Profiel bewerken","Elevation along crosssection (source: AHN2).":"Maaiveldhoogte langs dwarsprofiel (bron: AHN2).","End":"Einde","End (simulation time)":"Einde (simulatietijd)","End of current timeline":"Einde van de huidige tijdlijn","Example value":"Voorbeeldwaarde","Export":"Exporteer","Export all selected timeseries":"Exporteer alle geselecteerde tijdreeksen","Export data":"Exporteer","Export info card data":"Exporteer infocard data","Export timeseries":"Exporteer tijdreeksen","Extraneous water":"Rioolvreemd water","Favourite name cannot be longer than 256 characters.":"Naam van favoriet mag niet langer zijn dan 256 karakters.","Favourite name is required.":"Naam van favoriet is vereist.","Favourites":"Favorieten","Filter":"Filter","Filter bottom level":"Onderkant filter","Filter top level":"Bovenkant filter","Frequency":"Frequentie","Go to modelbank":"Ga naar modellendatabank","Go to the present in timeline":"Ga naar het heden in de tijdlijn","Green line":"Groene lijn","Grey dots":"Grijze punten","Groundwater station":"Grondwatermeetpunt","Height":"Hoogte","Help":"Help","Inhabitants":"Inwoners","Invert level end point":"BOB eindpunt","Invert level start point":"BOB beginpunt","Layer could not be added":"Laag kon niet worden toegevoegd","Length":"Lengte","Levee":"Kering","Levee cross section":"Dijkdwarsdoorsnede","Levee reference point":"Keringreferentiepunt","Line selection":"Lijnselectie","Litology":"Lithologie","Locations":"Locaties","Log in":"Inloggen","Log out":"Uitloggen","Make time relative (sticky to the end)":"Maak tijd relatief (t.o.v. het nu)","Manhole":"Put","Manhole id":"Put id","Material":"Materiaal","Measured hydraulic head at current time.":"Huidige gemeten stijghoogte.","Measuring station":"Meetstation","Messages <span class=\"badge\" ng-bind=\"inbox.length\"></span>":"Berichten <span class=\"badge\" ng-bind=\"inbox.length\"></span>","Minimum overflow crest level":"Laagste overstorthoogte","Model:":"Model:","Modify profile":"Profiel aanpassen","Monitoring well":"Waterspanningsmeter","Name":"Naam","Never mind":"Nee, bedankt","New favourite name...":"Nieuwe naam van favoriet...","No":"Nee","No data available for this location":"Geen data beschikbaar voor deze locatie","No raster data available for this geometry":"Geen raster data beschikbaar voor deze geometrie","No timeseries available for this asset":"Geen tijdreeksen beschikbaar voor dit object","One annotation":["Eén annotatie","<% $count %> annotaties"],"Oops! Something went wrong while creating the annotation.":"Oeps! Er is iets misgegaan bij het aanmaken van de annotatie.","Oops! Something went wrong while creating the favourite.":"Oeps! Er is iets misgegaan bij het aanmaken van de favoriet.","Oops! Something went wrong while deleting the annotation.":"Oeps! Er is iets misgegaan bij het verwijderen van de annotatie.","Oops! Something went wrong while deleting the favourite.":"Oeps! Er is iets misgegaan bij het verwijderen van de favoriet.","Oops! Something went wrong while fetching the favourites.":"Oeps! Er is iets misgegaan bij het ophalen van de favorieten.","Oops! Something went wrong while fetching the layers.":"Oeps! Er is iets misgegaan bij het ophalen van de lagen.","Oops! Something went wrong while fetching your organisations.":"Oeps! Er is iets misgegaan bij het ophalen van uw organisaties.","Open data menu":"Open het datamenu","Open timeline":"Open de tijdlijn","Open water level (average)":"Buitenwaterstand (gemiddeld)","Orifice":"Doorlaat","Outlet":"Uitlaat","Overflow":"Overstort","Pick the date range:":"Kies de periode:","Pipe":"Leiding","Play/pause":"Play/pauze","Point selection":"Puntselectie","Pollution equivalent":"Vervuilingseenheid","Population equivalent":"Inwonersequivalent","Pressure pipe":"Persleiding","Primary channel":"Primaire watergang","Pump":"Pomp","Pump station":"Gemaal","Pump station capacity":"Bemalingscapaciteit","Pumped drainage area":"Bemalingsgebied","Question and manual":"Vragen en handleiding","RT (years)":"HT (jaren)","Rain":"Regen","Rain recurrence statistics":"Neerslagstatistiek","Recurrence times (RT)":"Herhalingstijden (HT)","Region selection":"Regio selectie","Restoring favourite":"Favoriet aan het terugzetten","Sanitary load":"Droogweerafvoer","Screen view":"Schermoverzicht","Search for places, or dates (i.e. 23-10-2013)":"Zoek naar plaatsen of data (bijv. 13-10-2013)","Select Multiple Points":"Selecteer Meerdere Punten","Select an organisation:":"Selecteer een organisatie:","Shape":"Vorm","Show Messages":"Toon Berichten","Sluice":"Sluis","Start":"Start","Start (simulation time)":"Start (simulatietijd)","Start Export":"Start de export","Start animation":"Start animatie","Start level":"Aanslagpeil","Start of current timeline":"Start van de huidige tijdlijn","Statistics":"Statistieken","Stop animation":"Stop animatie","Stop level":"Afslagpeil","Surface level":"Maaiveldhoogte","The 'now' of the timeline":"Het 'nu' van de tijdlijn","Time":"Tijd","Timeseries":"Tijdreeksen","Top level":"Bovenkant buis","Total:":"Totaal:","Type":"Type","Upstream load":"Bovenstroomse aanvoer","View selection":"Schermselectie","Wastewater treatment plant":"Afvalwaterzuivering","Water consumption":"Drinkwaterverbruik","Water retention capacity":"Bergingscapaciteit","We will let you know when your download is ready. You're welcome to\n      wait here, but we're not sure how long it will take to piece everything\n      together.":"We laten het weten als de download klaar is. U kunt hierop wachten,\nmaar we weten niet hoe lang het duurt om alle gegevens te verzamelen.","We're piecing stuff together, you can either wait\n        patiently or see if it's ready yourself by following\n        <a ng-href=\"<% taskInfo.url %>\" translate=\"\">this link</a>":"We zijn de gegevens aan het verzamelen. U kunt\nhierop wachten of de voortgang checken via\n<a ng-href=\"<% taskInfo.url %>\" translate=\"\">deze link</a>","Weir":"Stuw","Well bottom level":"Onderkant put","Well top level":"Bovenkant put","Whoops: favourite has been removed":"Oeps: favoriet is verwijderd.","Width":"Breedte","Yes":"Ja","You can select multiple time series to download. Once selected, press the\n      <i>\"Start Export\"</i> button and the exporter will fetch the time series\n      behind the scenes.":"U kunt meerdere tijdreeksen selecteren om te downloaden. Eenmaal\ngeselecteerd, drukt u op <i>\"Start de export\"</i> knop en de export\nzal achter de schermen gaan draaien.","You don't have any favourites yet.<br>\nAdd the current portal state to your favourites!":"U heeft nog geen favorieten.<br>\nVoeg de huidige status van het portaal toe aan uw favorieten!","You need to be logged in for this favourite, do you want to log in now?":"Je moet ingelogd zijn voor deze favoriet, wil je nu inloggen?","Zoom in on the map":"Zoom in op de kaart","Zoom in on timeline":"Zoom in op de tijdlijn","Zoom out of timeline":"Zoom uit van de tijdlijn","Zoom out on the map":"Zoom uit van de kaart","download\n        <i class=\"fa fa-2x fa-download\"></i>":"download\n<i class=\"fa fa-2x fa-download\"></i>","indicative interpolation of hydraulic head in the same aquifer.":"Indicatieve interpolatie van stijghoogte in hetzelfde watervoerend pakket.","mm":"mm","mm / 5 min":"mm / 5 min","mm / day":"mm / dag","mm / hour":"mm / uur","mm / month":"mm / maand","this link":"deze link"});
...
angular.module('templates-main', ['annotations/templates/annotations-make.html', 'annotations/templates/annotations-view.html', 'annotations/templates/annotations.html', 'dashboard/crosssection.html', 'dashboard/dashboard.html', 'data-menu/templates/annotations-layer.html', 'data-menu/templates/baselayers.html', 'data-menu/templates/data-menu-item.html', 'data-menu/templates/data-menu.html', 'data-menu/templates/layer-adder.html', 'data-menu/templates/layer.html', 'data-menu/templates/scenario.html', 'export/export-selector.html', 'favourites/templates/favourites-add.html', 'favourites/templates/favourites-share.html', 'favourites/templates/favourites-show.html', 'favourites/templates/favourites.html', 'graph/graph.html', 'image-carousel/image-carousel.html', 'omnibox/templates/asset-cards.html', 'omnibox/templates/card-header.html', 'omnibox/templates/cardattributes.html', 'omnibox/templates/close-card.html', 'omnibox/templates/color-picker.html', 'omnibox/templates/dashboard-cards.html', 'omnibox/templates/db-asset-card.html', 'omnibox/templates/db-cards.html', 'omnibox/templates/db-geometry-cards.html', 'omnibox/templates/db-nested-asset-card.html', 'omnibox/templates/defaultpoint.html', 'omnibox/templates/empty.html', 'omnibox/templates/full-details.html', 'omnibox/templates/geometry-cards.html', 'omnibox/templates/nestedasset.html', 'omnibox/templates/omnibox.html', 'omnibox/templates/rain.html', 'omnibox/templates/search-results.html', 'omnibox/templates/search.html', 'omnibox/templates/summary-card.html', 'opacity/opacity.html', 'timeline/timeline.html', 'timeseries/timeseries.html', 'ui-utils/modal-base.html', 'user-menu/user-menu.html']);
...
angular.module("annotations/templates/annotations-view.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("annotations/templates/annotations-view.html",
    ...
    "        <td ng-click=\"showFullText = !showFullText\"\n" +
    "            ng-class=\"{'show-full-text': showFullText}\"\n" +
    "            class=\"clickable\">\n" +
    "          <% obj.properties.text %>\n" +
    "        </td>\n" +
    "        <td class=\"text-right\">\n" +
...
angular.module("annotations/templates/annotations.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("annotations/templates/annotations.html",
    ...
    "    </span>\n" +
    "\n" +
    "    <full-details default=\"false\"></full-details>\n" +
    "\n" +
    "    <annotations-view\n" +
...
angular.module("data-menu/templates/annotations-layer.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("data-menu/templates/annotations-layer.html",
    "<div class=\"noselect\">\n" +
    "  <label\n" +
    "    single-click=\"annotations.active = !annotations.active\"\n" +
    "    ng-class =\"{active: annotations.active }\"\n" +
    "    class=\"layer-item layer-img\"\n" +
    "    title=\"Annotations layer\">\n" +
...
angular.module("data-menu/templates/baselayers.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("data-menu/templates/baselayers.html",
    "<li>\n" +
    ...
    "      <span translate><% state.baselayer | translate | capitalize %></span>\n" +
    "    </label>\n" +
    "  </div>\n" +
    "</li>\n" +
    "");
...
angular.module("data-menu/templates/data-menu-item.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("data-menu/templates/data-menu-item.html",
...
angular.module("data-menu/templates/data-menu.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("data-menu/templates/data-menu.html",
    ...
    "      box-type=\"menu.box.type\"\n" +
    "      type=\"multi-point\" icon=\"th\">\n" +
    "    </datamenu-item>\n" +
    "    <datamenu-item\n" +
    "      title=\"<% 'Line selection' | translate %>\"\n" +
    "      box-type=\"menu.box.type\"\n" +
    "      type=\"line\" icon=\"expand\">\n" +
    "    </datamenu-item>\n" +
    "    <datamenu-item\n" +
    "      title=\"<% 'Region selection' | translate %>\"\n" +
    "      box-type=\"menu.box.type\"\n" +
    "      type=\"region\" icon=\"lemon-o\">\n" +
    "    </datamenu-item>\n" +
    "    <datamenu-item\n" +
    "      title=\"<% 'View selection' | translate %>\"\n" +
    "      box-type=\"menu.box.type\"\n" +
    "      type=\"area\" icon=\"square-o\">\n" +
    "    </datamenu-item>\n" +
    "  </div>\n" +
    "\n" +
    "  <div ng-show=\"!menu.layerAdderEnabled\" class=\"layer-switcher\">\n" +
    "    <ul class=\"list-group\">\n" +
    "      <div class=\"layer-menu-explanation\">Selecteer kaartlagen:</div>\n" +
...
angular.module("data-menu/templates/layer-adder.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("data-menu/templates/layer-adder.html",
    ...
    "      <tr\n" +
    "        class=\"clickable\"\n" +
    "        ng-repeat=\"layer in availableLayers.results\"\n" +
    "        ng-click=\"addLayer(layer)\"\n" +
    "        ng-mouseenter=\"hovering=true\"\n" +
    "        ng-mouseleave=\"hovering=false\">\n" +
    "        <td>\n" +
    "          <i ng-class=\"hovering ? 'fa fa-plus' : layer.entity_name === 'scenario' ? 'lz lz-threedi threedi-icon' : 'fa fa-map'\">\n" +
    "          </i>\n" +
    "        </td>\n" +
    "        <td><% layer.title %></td>\n" +
    ...
    "    </tbody>\n" +
    "  </table>\n" +
    "  <uib-pagination total-items=\"availableLayers.count\"\n" +
    "                  ng-model=\"layersCurrentPage\"\n" +
    "                  max-size=\"8\"\n" +
    "                  class=\"pagination-sm\"\n" +
...
angular.module("data-menu/templates/layer.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("data-menu/templates/layer.html",
    "<div class=\"noselect\">\n" +
    "  <label\n" +
    "    single-click=\"layer.active = !layer.active\"\n" +
    "    ng-dblclick=\"rescale && rescale(layer)\"\n" +
    "    ng-class =\"{active: layer.active }\"\n" +
    "    class=\"layer-item layer-img\"\n" +
    "    ng-title=\"layer.name | capitalize\">\n" +
    "      <span ng-show=\"!invalid\" ng-bind=\"layer.name | capitalize\"></span>\n" +
    "      <del\n" +
    "        ng-show=\"invalid\"\n" +
    "        class=\"text-muted\"\n" +
    "        title=\"<% 'Layer could not be added' | translate %>\"\n" +
    "        ng-bind=\"layer.name | capitalize\">\n" +
    "      </del>\n" +
    "      <div class=\"layer-chooser-tools\">\n" +
    "        <i class=\"fa fa-close\"\n" +
    "           ng-click=\"remove(layer); $event.stopPropagation()\"></i>\n" +
    "        <i ng-if=\"zoomToBounds\"\n" +
    "          ng-click=\"zoomToBounds(); $event.stopPropagation()\"\n" +
    "          ng-show=\"layer.active\"\n" +
    ...
    "</div>\n" +
    "\n" +
    "<opacity-slider title=\"<% tooltips.transparency %>\" layer=\"layer\"></opacity-slider>\n" +
    "");
}]);

angular.module("data-menu/templates/scenario.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("data-menu/templates/scenario.html",
    "<div>\n" +
    "\n" +
    ...
    "        </tr>\n" +
    "\n" +
    "        <tr ng-if=\"result.raster\" ng-repeat=\"result in scenario.result_set\">\n" +
    "          <td colspan=\"2\">\n" +
    "            <rasterlayer\n" +
    "              ng-if=\"result.raster\"\n" +
    "              layer=\"result.layer\">\n" +
    ...
    "              <span ng-if=\"result.result_type.code === 'damage'\">\n" +
    ...
    "              </span>\n" +
    "            </div>\n" +
    "            <div ng-if=\"result.attachment_url\">\n" +
    "              <span>\n" +
    "                <a href=\"<% result.attachment_url %>\" target=\"_blank\">\n" +
    "                   <% result.layer.name %></a>\n" +
    "              </span>\n" +
    "            </div>\n" +
    "          </td>\n" +
    ...
    "        <span ng-repeat=\"result in scenario.result_set\">\n" +
    "          <span>\n" +
    "            <a href=\"<% result.attachment_url %>\" target=\"_blank\" translate>\n" +
    "               <% result.result_type.name %></a>\n" +
    "          </span>\n" +
    "        </span>\n" +
...
angular.module("export/export-selector.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("export/export-selector.html",
    "<div>\n" +
...
angular.module("favourites/templates/favourites-show.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("favourites/templates/favourites-show.html",
    ...
    "    </colgroup>\n" +
    "    <tbody>\n" +
    "      <tr ng-repeat=\"obj in favourites.data | orderBy : 'name'\">\n" +
    "        <td ng-click=\"selectFavourite(obj)\"\n" +
    "            class=\"clickable\">\n" +
    "          <i class=\"fa text-primary\" ng-class=\"obj.state.context === 'map' ? 'fa-globe': 'fa-bar-chart'\"></i>\n" +
    "        </td>\n" +
    "        <td ng-click=\"selectFavourite(obj)\"\n" +
    "            class=\"clickable\">\n" +
    "          <% obj.name %>\n" +
...
angular.module("omnibox/templates/cardattributes.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("omnibox/templates/cardattributes.html",
    ...
    "\n" +
    "        <td class=\"lineout\"\n" +
    "            ng-if=\"waterchain[obj.attrName] !== 'pumps'\n" +
    "              && waterchain[obj.attrName] !== 'filters'\">\n" +
    "          <span class=\"attr-row-content\" ng-bind-html=\"$eval(obj.ngBindValue)\">\n" +
    "          </span>&nbsp;<span class=\"attr-row-content\" ng-bind-html=\"obj.valueSuffix\"></span>\n" +
    "        </td>\n" +
    "\n" +
    "      </tr>\n" +
    "    </table>\n" +
...
angular.module("omnibox/templates/db-asset-card.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("omnibox/templates/db-asset-card.html",
    ...
    "              ng-class=\"{'text-primary bg-warning': ts.active}\">\n" +
    "              <% getTsMetaData(ts.uuid).location %>,\n" +
    "              <% getTsMetaData(ts.uuid).name %>,\n" +
...
angular.module("omnibox/templates/db-cards.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("omnibox/templates/db-cards.html",
    ...
    "    asset=\"asset\"\n" +
    "    assets=\"omnibox.data.assets\"\n" +
    "    ng-repeat=\"asset in localAssets\">\n" +
    "  </db-asset-card>\n" +
    "\n" +
    "  <div\n" +
...
angular.module("omnibox/templates/db-nested-asset-card.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("omnibox/templates/db-nested-asset-card.html",
    "<div>\n" +
    "  <db-asset-card ng-repeat=\"a in list\"\n" +
...
angular.module("omnibox/templates/geometry-cards.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("omnibox/templates/geometry-cards.html",
    ...
    "           ng-csv=\"formatLineCSV(uuid, properties)\"\n" +
    "           field-separator=\";\"\n" +
    "           filename=\"<% uuid %>.csv\"\n" +
    "           csv-header=\"getLineCSVHeaders(uuid, properties)\">\n" +
    ...
    "\n" +
    "        <graph\n" +
    "          ng-if=\"properties.aggType === 'curve'\"\n" +
    "          line\n" +
    "          xlabel=\"'[%]'\"\n" +
    ...
    "\n" +
    "        <graph\n" +
    "          ng-if=\"properties.aggType === 'histogram'\"\n" +
    "          bar-chart\n" +
    "          quantity=\"'linear'\"\n" +
    "          ylabel=\"'[%]'\"\n" +
    ...
    "\n" +
    "        <graph\n" +
    "          ng-if=\"properties.aggType === 'counts'\"\n" +
    "          horizontal-stack\n" +
    "          data=\"properties.data\"\n" +
    "          keys=\"{x: 'data', y: 'label'}\"\n" +
    "          xlabel=\"'[%]'\"\n" +
    ...
    "        </graph>\n" +
    "\n" +
    "        <div ng-if=\"properties.aggType !== 'histogram' && properties.aggType !== 'curve' && properties.aggType !== 'counts'\">\n" +
    "\n" +
    "          <graph\n" +
...
angular.module("omnibox/templates/nestedasset.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("omnibox/templates/nestedasset.html",
    ...
    "            : a.serial !== '' ? a.serial\n" +
    "            : a.id\n" +
    "            for a in list | orderBy:'filter_bottom_level' track by a.id\">\n" +
    "        </select>\n" +
    "\n" +
    "      </div>\n" +
    "    </div>\n" +
...
angular.module("opacity/opacity.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("opacity/opacity.html",
    "<div class=\"ng-class: {inactive: !layer.active || layer.type === 'eventseries' || layer.type === 'annotations'}; progress\"\n" +
    "	ng-click=\"adjustOpacity($event)\" ng-touch=\"adjustOpacity($event)\">\n" +
    "    <div class=\"progress-bar\" role=\"progressbar\" ng-style=\"{ 'width': getWidth(layer.opacity) }\">\n" +
...
angular.module("timeline/timeline.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("timeline/timeline.html",
    "<div id=\"timeline\" class=\"timeline navbar-fixed-bottom material-shadow\" ng-controller=\"TimeCtrl as timeline\">\n" +
    "\n" +
    ...
    "            class=\"fa\"\n" +
    "            ng-class=\"{\n" +
    "              'fa-circle-o-notch fa-spin': timeline.MapService.loading,\n" +
    "              'fa-pause active': timeline.state.temporal.playing,\n" +
    "              'fa-play': !timeline.state.temporal.playing && !timeline.MapService.loading,\n" +
    "              }\">\n" +
    "          </span>\n" +
    "        </a>\n" +
    "      </div>\n" +
...
angular.module("ui-utils/modal-base.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("ui-utils/modal-base.html",
    "<div id=\"MotherModal\" class=\"modal fade\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"popup\" aria-hidden=\"true\"\n" +
...
angular.module("user-menu/user-menu.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("user-menu/user-menu.html",
    ...
    "      <span class=\"pull-left text-muted\">Version: <% about.version.version%></span>\n" +
