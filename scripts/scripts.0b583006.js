...
angular.module("dashboard/dashboard.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("dashboard/dashboard.html",
    ...
    "  <div class=\"row\">\n" +
    "    <h2>Welkom <% user.firstName %> - <% dashboard.name %></h2>\n" +
    "  </div>\n" +
...
angular.module("omnibox/templates/search.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("omnibox/templates/search.html",
    ...
    "    ng-change=\"search()\"\n" +
    "    tabindex=\"-1\"\n" +
    "    placeholder=\"Zoeken op plaats, of datum (bv. 23-10-2013)\"\n" +
    "    autocomplete=\"off\"\n" +
    "    dir=\"ltr\"\n" +
    "    ng-model=\"query\"\n" +
...
angular.module("omnibox/templates/timeseries.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("omnibox/templates/timeseries.html",
    ...
    "            ng-options=\"series.name for series in timeseries.data | rmSingleDatumTimeseries\">\n" +
    "     </select>\n" +
    "     <span class=\"card-title-text placeholder\"\n" +
    "           ng-if=\"timeseries.data.length === 1 && fullDetails\">\n" +
    "           <% timeseries.selectedTimeseries.name %>\n" +
    "     </span>\n" +
    "     <span class=\"card-title-text placeholder\" ng-class=\"{hidden: fullDetails}\" >Tijdreeksen</span>\n" +
    "     <full-details></full-details>\n" +
    "  </div>\n" +
    "\n" +
    "  <br>\n" +
    ...
    "         'Datestamp',\n" +
    "         'Timestamp',\n" +
    "         timeseries.parameter_referenced_unit.referenced_unit_short_display_name + 'min',\n" +
    "         timeseries.parameter_referenced_unit.referenced_unit_short_display_name + 'max'\n" +
    "       ]\">\n" +
    "       <i class=\"fa fa-share-square-o\"></i>\n" +
    "       Exporteer\n" +
    "     </a>\n" +
...
angular.module("user-menu/user-menu.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("user-menu/user-menu.html",
    ...
    "  </div>\n" +
    "\n" +
    "  <a class=\"hidden-xs help\" href=\"https://www.lizard.net/support\" title=\"Vragen en handleiding\" target=\"_blank\">\n" +
