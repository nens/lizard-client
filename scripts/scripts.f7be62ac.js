...
angular.module('templates-main', ['dashboard/dashboard.html', 'data-menu/data-menu.html', 'graph/graph.html', 'layer-chooser/baselayer-chooser.html', 'layer-chooser/eventlayer-chooser.html', 'layer-chooser/layer-chooser.html', 'omnibox/templates/area.html', 'omnibox/templates/cardattributes.html', 'omnibox/templates/defaultpoint.html', 'omnibox/templates/empty.html', 'omnibox/templates/full-details.html', 'omnibox/templates/line.html', 'omnibox/templates/location.html', 'omnibox/templates/omnibox-search.html', 'omnibox/templates/point.html', 'omnibox/templates/rain.html', 'omnibox/templates/search.html', 'omnibox/templates/timeseries.html', 'opacity/opacity.html', 'scenarios/scenarios.html', 'time-ctx/time-ctx.html', 'timeline/timeline.html', 'user-menu/user-menu.html']);
...
angular.module("omnibox/templates/location.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("omnibox/templates/location.html",
    "<div ng-cloak\n" +
    "  ng-repeat=\"location in box.content.location\"\n" +
    "  class=\"cluster location\">\n" +
    "  <i class=\"fa fa-map-marker\"></i>&nbsp;\n" +
    "  <a ng-click=\"zoomTo(location)\"\n" +
    "    class=\"pointer clickable\">\n" +
    "    <span><% location.formatted_address %></span></a>\n" +
    "</div>\n" +
    "\n" +
    "");
}]);
