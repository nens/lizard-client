...
angular.module("omnibox/templates/timeseries.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("omnibox/templates/timeseries.html",
    ...
    "            ng-class=\"{hidden: ($parent.box.content.timeseries.data.length === -1) || !fullDetails}\"\n" +
    ...
    "            ng-class=\"{hidden: ($parent.box.content.timeseries.data.length > 0) || !fullDetails}\">\n" +
    "       <% $parent.box.content.timeseries.data[0].name %>\n" +
    "     </span>\n" +
