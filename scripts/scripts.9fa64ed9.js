    ...
    rows: [
      {
        ...
        ngBindValue: "waterchain.filter_top_level",
        valueSuffix: " (m)",
        defaultValue: ""
      },
      {
        ...
        ngBindValue: "waterchain.filter_bottom_level",
        valueSuffix: " (m)",
        defaultValue: ""
      },
      {
...
angular.module('templates-main', ['annotations/templates/annotations-make.html', 'annotations/templates/annotations-view.html', 'annotations/templates/annotations.html', 'dashboard/dashboard.html', 'data-menu/data-menu-item.html', 'data-menu/data-menu.html', 'graph/graph.html', 'layer-chooser/baselayer-chooser.html', 'layer-chooser/eventlayer-chooser.html', 'layer-chooser/layer-chooser.html', 'omnibox/templates/asset-cards.html', 'omnibox/templates/card-header.html', 'omnibox/templates/cardattributes.html', 'omnibox/templates/close-card.html', 'omnibox/templates/dashboard-cards.html', 'omnibox/templates/db-asset-card.html', 'omnibox/templates/defaultpoint.html', 'omnibox/templates/empty.html', 'omnibox/templates/full-details.html', 'omnibox/templates/geometry-cards.html', 'omnibox/templates/nestedasset.html', 'omnibox/templates/omnibox.html', 'omnibox/templates/rain.html', 'omnibox/templates/search-results.html', 'omnibox/templates/search.html', 'omnibox/templates/summary-card.html', 'opacity/opacity.html', 'scenarios/scenarios.html', 'timeline/timeline.html', 'timeseries/timeseries.html', 'user-menu/user-menu.html']);
...
angular.module("dashboard/dashboard.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("dashboard/dashboard.html",
    ...
    "\n" +
    "    <div class=\"row\" ng-repeat=\"item in dashboard.graphs\">\n" +
    "      <div class=\"dashboard-inner\">\n" +
    "        <graph\n" +
    "         line\n" +
    "         content=\"dashboard.content\"\n" +
    "         temporal=\"dashboard.state.temporal\"\n" +
    "         dimensions=\"dashboard.dims\"\n" +
    "         >\n" +
    "         <graph/>\n" +
    "<!--\n" +
    "        <graph\n" +
...
angular.module("data-menu/data-menu-item.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("data-menu/data-menu-item.html",
    "<div class=\"button-list-item clickable\">\n" +
    "  <a ng-click=\"changeBoxType()\"\n" +
    "     ng-class=\"{'active': boxType === type}\">\n" +
...
angular.module("data-menu/data-menu.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("data-menu/data-menu.html",
    ...
    "    <div class=\"layer-switcher-wrapper material-shadow\"\n" +
    ...
    "        <div class=\"button-list-item\" ng-click=\"menu.enabled = !menu.enabled\">\n" +
...
angular.module("omnibox/templates/asset-cards.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("omnibox/templates/asset-cards.html",
    ...
    "    </div>\n" +
    "    <timeseries ng-if=\"longFormat\"\n" +
    "      ng-if=\"asset.num_timeseries &&\n" +
    "             context !== 'dashboard'\"\n" +
    "      asset=\"asset\"\n" +
    "      time-state=\"timeState\">\n" +
    "    </timeseries>\n" +
    ...
    "  </div>\n" +
    "\n" +
    "  <geometry-cards geom=\"asset\" header=\"false\"></geometry-cards>\n" +
    "\n" +
    "</div>\n" +
    "\n" +
    "");
...
angular.module("omnibox/templates/dashboard-cards.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("omnibox/templates/dashboard-cards.html",
    "<div ng-controller=\"DashboardCardCtrl as db\">\n" +
    "\n" +
    "  <div class=\"card active\" ng-repeat=\"asset in db.selected.assets\">\n" +
    "    <db-asset-card asset-id=\"asset\"></db-asset-card>\n" +
    "  </div>\n" +
    "\n" +
    "</div>\n" +
    "");
...
angular.module("omnibox/templates/db-asset-card.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("omnibox/templates/db-asset-card.html",
    ...
    "  <div class=\"card-content\">\n" +
    "\n" +
    "    <em ng-if=\"ts.length === 0\" translate>No data available for this asset</em>\n" +
    "\n" +
    "    <div ng-repeat=\"s in ts\">\n" +
...
angular.module("omnibox/templates/geometry-cards.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("omnibox/templates/geometry-cards.html",
    ...
    "\n" +
    "  <rain\n" +
    "    ng-if=\"geom.properties.rain\"\n" +
    "    rain=\"geom.properties.rain\"\n" +
    "    state=\"omnibox.state\">\n" +
    "  </rain>\n" +
    "\n" +
    "  <annotations\n" +
    ...
    "\n" +
    "  <div\n" +
    "    ng-if=\"geom.geometry.type === 'Polygon' && slug !== 'rain'\"\n" +
    "    class=\"card active\">\n" +
    ...
    "\n" +
    "        <graph\n" +
    "          ng-if=\"geom.properties.elevation.aggType === 'curve'\"\n" +
    "          line xlabel=\"'[%]'\"\n" +
    "          ylabel=\"geom.properties.elevation.unit\"\n" +
    "          data=\"geom.properties.elevation.data\"\n" +
    "          keys=\"{x: 0, y: 1}\">\n" +
    "        </graph>\n" +
    "\n" +
    "        <graph\n" +
...
angular.module("omnibox/templates/omnibox.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("omnibox/templates/omnibox.html",
    ...
    "      ng-repeat=\"asset in omnibox.data.assets track by $index\"\n" +
    "      asset=\"asset\" >\n" +
    "    </db-asset-card>\n" +
    "\n" +
...
angular.module("omnibox/templates/rain.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("omnibox/templates/rain.html",
    ...
    "           ng-csv=\"$parent.formatCSVColumns(rain.data)\"\n" +
    "           field-separator=\";\"\n" +
...
angular.module("timeseries/timeseries.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("timeseries/timeseries.html",
    ...
    "        ng-class=\"{hidden: !fullDetails}\"\n" +
    "        ng-if=\"timeseries.selectedTimeseries.type === 'bar-chart'\">\n" +
    "       <graph\n" +
    "          bar-chart\n" +
    "          type=\"temporal\"\n" +
    "          temporal=\"timeState\"\n" +
    "          content=\"timeseries.selectedTimeseries.content\"\n" +
    "          now=\"timeState.at\">\n" +
    "        </graph>\n" +
    "    </div>\n" +
    "\n" +
