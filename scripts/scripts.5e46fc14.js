...
/* jshint -W100 */
    gettextCatalog.setStrings('en', {"(preview)":"(preview)","3di resultaten":"3di resultaten","Adjust opacity":"Adjust opacity","Baselayer":"Baselayer","Bottom level":"Bottom level","Bottom level manhole":"Bottom level manhole","Capacity":"Capacity","Category":"Category","Close data menu":"Close data menu","Close result window":"Close result window","Coating":"Coating","Code":"Code","Construction year":"Construction year","Control":"Control","Crest Level":"Crest Level","Crest height":"Crest height","Crest level":"Crest level","Crest width":"Crest width","Diameter":"Diameter","Double click for lizard version number":"Double click for lizard version number","Download":"Download","Duration":"Duration","End":"End","End of current timeline":"End of current timeline","Ended (simulation time)":"Ended (simulation time)","Example value":"Example value","Export":"Export","Export info card data":"Export info card data","Extra statistieken, herhalingstijden":"Extra statistieken, herhalingstijden","Filter bottom level":"Filter bottom level","Filter top level":"Filter top level","Frequency":"Frequency","Go to the present in timeline":"Go to the present in timeline","Height":"Height","Invert level end point":"Invert level end point","Invert level start point":"Invert level start point","Length":"Length","Line selection":"Line selection","Log in":"Log in","Log out":"Log out","Manhole id":"Manhole id","Material":"Material","Modify profile":"Modify profile","Name":"Name","No results":"No results","Open data menu":"Open data menu","Open water level (average)":"Open water level (average)","Play/pause":"Play/pause","Point selection":"Point selection","Question and manual":"Question and manual","RT (years)":"RT (years)","Rain":"Rain","Recurrence times (RT)":"Recurrence times (RT)","Region selection":"Region selection","Search for places, or dates (i.e. 23-10-2013)":"Search for places, or dates (i.e. 23-10-2013)","Shape":"Shape","Show dashboard":"Show dashboard","Show map":"Show map","Start":"Start","Start animation":"Start animation","Start level":"Start level","Start of current timeline":"Start of current timeline","Started (simulation time)":"Started (simulation time)","Statistics":"Statistics","Stop animation":"Stop animation","Stop level":"Stop level","Surface level":"Surface level","The 'now' of the timeline":"The 'now' of the timeline","Timeseries":"Timeseries","Top level":"Top level","Type":"Type","View selection":"View selection","Welcome <% user.firstname=\"\" %=\"\"> - <% dashboard.name=\"\" %=\"\"></%></%>":"Welcome <% user.firstname=\"\" %=\"\"> - <% dashboard.name=\"\" %=\"\"></%></%>","Widht":"Widht","Width":"Width","Zoom in on the map":"Zoom in on the map","Zoom in on timeline":"Zoom in on timeline","Zoom out of timeline":"Zoom out of timeline","Zoom out on the map":"Zoom out on the map","mm":"mm"});
    gettextCatalog.setStrings('nl', {"(preview)":"(preview)","3di resultaten":"3di resultaten","Adjust opacity":"Transparantie aanpassen","Baselayer":"Basislaag","Bottom level":"Onderkant buis","Bottom level manhole":"Putbodem","Capacity":"Capaciteit","Category":"Categorie","Close data menu":"Sluit het datamenu","Close result window":"Sluit het resultatenvenster","Coating":"Bekleding","Code":"Code","Construction year":"Bouwjaar","Control":"Bediening","Crest Level":"Niveau","Crest height":"Kruinhoogte","Crest level":"Overstorthoogte","Crest width":"Overstortbreedte","Diameter":"Diameter","Double click for lizard version number":"Dubbelklikken voor lizard versienummer","Download":"Download","Duration":"Duur","End":"Einde","End of current timeline":"Einde van de huidige tijdlijn","Ended (simulation time)":"Einde (simulatie tijd)","Export":"Exporteer","Export info card data":"Exporteer infocard data","Extra statistieken, herhalingstijden":"Extra statistieken, herhalingstijden","Filter bottom level":"Onderkant filter","Filter top level":"Bovenkant filter","Frequency":"Frequentie","Go to the present in timeline":"Ga naar het heden in de tijdlijn","Height":"Hoogte","Invert level end point":"BOB eindpunt","Invert level start point":"BOB beginpunt","Length":"Lengte","Line selection":"Lijnselectie","Log in":"Inloggen","Log out":"Uitloggen","Manhole id":"Put id","Material":"Materiaal","Modify profile":"Profiel aanpassen","Name":"Naam","No results":"Geen resultaten","Open data menu":"Open het datamenu","Open water level (average)":"Buitenwaterstand (gemiddeld)","Play/pause":"Play/pauze","Point selection":"Puntselectie","Question and manual":"Vragen en handleiding","Rain":"Regen","Recurrence times (RT)":"Herhalingstijden (HT)","Region selection":"Regio selectie","Search for places, or dates (i.e. 23-10-2013)":"Zoek naar plaatsen of data (bv. 23-10-2013)","Shape":"Vorm","Show dashboard":"Toon het dashboard","Show map":"Toon de kaart","Start":"Start","Start animation":"Start animatie","Start level":"Aanslagpeil","Start of current timeline":"Start van de huidige tijdlijn","Started (simulation time)":"Start (simulatie tijd)","Statistics":"Statistieken","Stop animation":"Stop animatie","Stop level":"Afslagpeil","Surface level":"Maaiveldhoogte","The 'now' of the timeline":"Het 'nu' van de tijdlijn","Timeseries":"Tijdreeksen","Top level":"Bovenkant buis","Type":"Type","View selection":"Schermselectie","Welcome <% user.firstname=\"\" %=\"\"> - <% dashboard.name=\"\" %=\"\"></%></%>":"Welkom <% user.firstname=\"\" %=\"\"> - <% dashboard.name=\"\" %=\"\"></%></%>\n ","Widht":"Breedte","Width":"Breedte","Zoom in on the map":"Zoom in op de kaart","Zoom in on timeline":"Zoom in op de tijdlijn","Zoom out of timeline":"Zoom uit van de tijdlijn","Zoom out on the map":"Zoom uit van de kaart","mm":"mm"});
/* jshint +W100 */
}]);
'use strict';
...
angular.module('templates-main', ['dashboard/dashboard.html', 'data-menu/data-menu.html', 'graph/graph.html', 'layer-chooser/baselayer-chooser.html', 'layer-chooser/eventlayer-chooser.html', 'layer-chooser/layer-chooser.html', 'omnibox/templates/area.html', 'omnibox/templates/cardattributes.html', 'omnibox/templates/defaultpoint.html', 'omnibox/templates/empty.html', 'omnibox/templates/full-details.html', 'omnibox/templates/line.html', 'omnibox/templates/omnibox-search.html', 'omnibox/templates/point.html', 'omnibox/templates/rain.html', 'omnibox/templates/region.html', 'omnibox/templates/search-results.html', 'omnibox/templates/search.html', 'omnibox/templates/timeseries.html', 'opacity/opacity.html', 'scenarios/scenarios.html', 'time-ctx/time-ctx.html', 'timeline/timeline.html', 'user-menu/user-menu.html']);
...
angular.module("omnibox/templates/region.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("omnibox/templates/region.html",
    ...
    "\n" +
    "  <div class=\"card active\" id=\"card-beta-warning\">\n" +
    "    <div class=\"card-content\">\n" +
    "      <strong>Regio aggregatie is momenteel in Bèta</strong>\n" +
    "    </div>\n" +
    "  </div>\n" +
    "\n" +
...
angular.module("scenarios/scenarios.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("scenarios/scenarios.html",
    ...
    "          <td ng-click=\"preview(result)\"><% result.result_type.name %> <a ng-if=\"result.layer_group\" translate>(preview)</a></td>\n" +
    "          <td><a href=\"<% result.attachment_url %>\" target=\"_blank\" translate>Download</a></td>\n" +
    "        </tr>\n" +
    "      </table>\n" +
...
angular.module("time-ctx/time-ctx.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("time-ctx/time-ctx.html",
    ...
    "          ylabel=\"item.parameter_referenced_unit.referenced_unit_short_display_name\"\n" +
    "          keys=\"{\n" +
    "            x: 'timestamp',\n" +
    "            y: { 'y0': 'min', 'y1': 'max' }\n" +
    "          }\"\n" +
