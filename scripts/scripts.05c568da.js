...
angular.module('templates-main', ['annotations/templates/annotations-make.html', 'annotations/templates/annotations-view.html', 'annotations/templates/annotations.html', 'dashboard/crosssection.html', 'dashboard/dashboard.html', 'data-menu/templates/annotations-layer.html', 'data-menu/templates/baselayers.html', 'data-menu/templates/data-menu-item.html', 'data-menu/templates/data-menu.html', 'data-menu/templates/layer-adder.html', 'data-menu/templates/layer.html', 'data-menu/templates/scenario.html', 'export/export-selector.html', 'favourites/templates/favourites-add.html', 'favourites/templates/favourites-share.html', 'favourites/templates/favourites-show.html', 'favourites/templates/favourites.html', 'graph/graph.html', 'image-carousel/image-carousel.html', 'omnibox/templates/asset-cards.html', 'omnibox/templates/card-header.html', 'omnibox/templates/cardattributes.html', 'omnibox/templates/close-card.html', 'omnibox/templates/color-picker.html', 'omnibox/templates/dashboard-cards.html', 'omnibox/templates/db-asset-card.html', 'omnibox/templates/db-cards.html', 'omnibox/templates/db-geometry-cards.html', 'omnibox/templates/defaultpoint.html', 'omnibox/templates/empty.html', 'omnibox/templates/full-details.html', 'omnibox/templates/geometry-cards.html', 'omnibox/templates/nestedasset.html', 'omnibox/templates/omnibox.html', 'omnibox/templates/rain.html', 'omnibox/templates/search-results.html', 'omnibox/templates/search.html', 'omnibox/templates/summary-card.html', 'opacity/opacity.html', 'timeline/timeline.html', 'timeseries/timeseries.html', 'ui-utils/modal-base.html', 'user-menu/user-menu.html']);
...
angular.module("data-menu/templates/scenario.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("data-menu/templates/scenario.html",
    ...
    "        </tr>\n" +
    "\n" +
    "        <tr ng-if=\"result.layer\" ng-repeat=\"result in scenario.result_set\">\n" +
    "          <td colspan=\"2\">\n" +
    "            <rasterlayer\n" +
    "              ng-if=\"result.raster\"\n" +
    "              layer=\"result.layer\">\n" +
    ...
    "            </div>\n" +
    "            <div>\n" +
    "              <span ng-if=\"result.attachment_url\">\n" +
