...
angular.module('templates-main', ['annotations/templates/annotations-make.html', 'annotations/templates/annotations-view.html', 'annotations/templates/annotations.html', 'dashboard/dashboard.html', 'data-menu/data-menu-item.html', 'data-menu/data-menu.html', 'data-menu/layer-adder.html', 'data-menu/layer-switcher.html', 'favourites/templates/favourites-add.html', 'favourites/templates/favourites-show.html', 'favourites/templates/favourites.html', 'graph/graph.html', 'layer-chooser/baselayer-chooser.html', 'layer-chooser/eventlayer-chooser.html', 'layer-chooser/layer-chooser.html', 'omnibox/templates/asset-cards.html', 'omnibox/templates/card-header.html', 'omnibox/templates/cardattributes.html', 'omnibox/templates/close-card.html', 'omnibox/templates/color-picker.html', 'omnibox/templates/dashboard-cards.html', 'omnibox/templates/db-asset-card.html', 'omnibox/templates/db-cards.html', 'omnibox/templates/db-geometry-cards.html', 'omnibox/templates/defaultpoint.html', 'omnibox/templates/empty.html', 'omnibox/templates/full-details.html', 'omnibox/templates/geometry-cards.html', 'omnibox/templates/nestedasset.html', 'omnibox/templates/omnibox.html', 'omnibox/templates/rain.html', 'omnibox/templates/search-results.html', 'omnibox/templates/search.html', 'omnibox/templates/summary-card.html', 'opacity/opacity.html', 'scenarios/scenarios.html', 'timeline/timeline.html', 'timeseries/timeseries.html', 'user-menu/user-menu.html']);
...
angular.module("annotations/templates/annotations-view.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("annotations/templates/annotations-view.html",
    ...
    "    </colgroup>\n" +
    "    <tbody>\n" +
    "      <tr ng-repeat=\"obj in annotations\">\n" +
    "        <td><% obj.text %></td>\n" +
    "        <td class=\"text-right\">\n" +
    "          <span ng-bind=\"obj.datetime_from | date: formatDatetime()\"></span>\n" +
    "        </td>\n" +
    "        <td class=\"text-right\">\n" +
    "          <a target=\"_blank\"\n" +
    "             href=\"<% obj.attachment_url %>\"\n" +
    "             title=\"<% 'Download attachment.'|translate %>\"\n" +
    "             ng-if=\"obj.attachment_url\">\n" +
...
angular.module("dashboard/dashboard.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("dashboard/dashboard.html",
    ...
    "\n" +
    "  <div ng-if=\"item.type !== 'empty'\" ng-repeat=\"item in dashboard.graphs\" data-order=\"<% $index %>\" class=\"row dashboard-inner\">\n" +
    "\n" +
    "    <graph\n" +
...
angular.module("data-menu/layer-adder.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("data-menu/layer-adder.html",
    ...
    "      <tr\n" +
    "        class=\"clickable\"\n" +
    "        ng-repeat=\"obj in availableLayerGroups | filter:searchLayerGroups\"\n" +
...
angular.module("favourites/templates/favourites-show.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("favourites/templates/favourites-show.html",
    ...
    "      <td ng-click=\"applyFavourite(obj)\"\n" +
    "          class=\"clickable\">\n" +
...
angular.module("omnibox/templates/asset-cards.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("omnibox/templates/asset-cards.html",
    ...
    "      <cardattributes waterchain=\"asset\"></cardattributes>\n" +
    "    </div>\n" +
    "    <timeseries\n" +
    ...
    "    </timeseries>\n" +
    "\n" +
    "    <annotations data=\"asset\" time-state=\"timeState\"></annotations>\n" +
    "\n" +
    "  <div ng-if=\"longFormat && (asset.filters\n" +
    "    || asset.pumps)\">\n" +
    "    <div class=\"card active\">\n" +
    "      <nestedasset\n" +
    "        asset=\"asset\">\n" +
...
angular.module("omnibox/templates/card-header.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("omnibox/templates/card-header.html",
    ...
    "    <close-card entity=\"asset.entity_name\" id=\"asset.id\"></close-card>\n" +
    "\n" +
    ...
    "      </span>\n" +
    "\n" +
    "      <span class=\"asset-title\" translate>\n" +
    "        <% asset.entity_name | objectTitle %>\n" +
    "      </span>\n" +
    "\n" +
    "      <br>\n" +
    ...
    "\n" +
    "    <span ng-if=\"geom.geometry.type === 'Point'\" class=\"asset-title\" translate>\n" +
    "      <% geom.geometry.coordinates[1] | number : 2 %>, <% geom.geometry.coordinates[0] | number : 2 %>\n" +
    "    </span>\n" +
    "    <span ng-if=\"geom.geometry.type === 'LineString'\">\n" +
    "      <% geom.geometry.coordinates[0][1] | number : 2 %>, <% geom.geometry.coordinates[0][0] | number : 2 %> - <% geom.geometry.coordinates[1][1] | number : 2 %>, <% geom.geometry.coordinates[0][1] | number : 2 %></span>\n" +
...
angular.module("omnibox/templates/cardattributes.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("omnibox/templates/cardattributes.html",
    "<div>\n" +
    "\n" +
    "  <cardheader asset=\"waterchain\"></cardheader>\n" +
    "\n" +
...
angular.module("omnibox/templates/db-asset-card.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("omnibox/templates/db-asset-card.html",
    "<div class=\"card active\">\n" +
    "\n" +
    "  <timeseries asset=\"asset\" timeState=\"timeState\"></timeseries>\n" +
    "\n" +
    "  <cardheader asset=\"asset\"></cardheader>\n" +
    "\n" +
    "  <div class=\"card-content\">\n" +
    "\n" +
    "    <em ng-if=\"noTimeseries\" translate>\n" +
    ...
    "           data-uuid=\"<% s.uuid %>\"\n" +
    "           class=\"draggable-ts\">\n" +
    "        <div ng-click=\"toggleTimeseries(s)\"\n" +
    "             class=\"card-content-list clickable\">\n" +
    "          <i class=\"fa fa-clock-o\"></i>\n" +
    "          <span ng-class=\"{'text-primary bg-warning': s.active}\">\n" +
    "            <% s.location.name %>,\n" +
    "            <% s.parameter_referenced_unit.parameter_short_display_name %>\n" +
    "          </span>\n" +
    "        </div>\n" +
...
angular.module("omnibox/templates/defaultpoint.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("omnibox/templates/defaultpoint.html",
    ...
    "            </td>\n" +
    "            <td class=\"col-md-11\">\n" +
    "              <% content.layerGroupName %>:&nbsp;<% content.data[0].label | discreteRasterType %>\n" +
    "            </td>\n" +
    ...
    "    </div>\n" +
    "\n" +
    "    <div ng-switch-when=\"WMS\" ng-if=\"content.data.features\">\n" +
    "      <div class=\"card-content\">\n" +
    "\n" +
    ...
    "\n" +
    "        <tr class=\"attr-row\"\n" +
    "            ng-repeat=\"(key, val) in content.data.features[0].properties\">\n" +
    "\n" +
    "          <td class=\"fixed-width-card-table\">\n" +
    "            <div class=\"attr-row-content\">\n" +
    "              <% key %>\n" +
...
angular.module("omnibox/templates/rain.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("omnibox/templates/rain.html",
    ...
    "           ng-csv=\"util.formatCSVColumns(rain.properties.rain.data, rain.geometry.coordinates)\"\n" +
    "           field-separator=\";\"\n" +
...
angular.module("omnibox/templates/search-results.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("omnibox/templates/search-results.html",
    ...
    "    </ul>\n" +
    "\n" +
    "    <h3 ng-if=\"omnibox.searchResults.timeseries.length > 0\">\n" +
    "      <i class=\"fa fa-clock-o\">&nbsp;</i>\n" +
    "      <span translate>Timeseries</span>&nbsp;(<% omnibox.searchResults.timeseries.length %>)\n" +
    "    </h3>\n" +
    "    <ul>\n" +
    "      <li ng-cloak\n" +
    ...
    "    </ul>\n" +
    "\n" +
    "    <h3 ng-if=\"omnibox.searchResults.layergroups.length > 0\">\n" +
    "      <i class=\"fa fa-clock-o\">&nbsp;</i>\n" +
    "      <span translate>Map</span>&nbsp;(<% omnibox.searchResults.layergroups.length %>)\n" +
    "    </h3>\n" +
    "    <ul>\n" +
    "      <li ng-cloak\n" +
    ...
    "    </ul>\n" +
    "\n" +
    "    <h3 ng-if=\"omnibox.searchResults.temporal.length > 0\" translate>Time</h3>\n" +
    "  	<div\n" +
...
angular.module("timeseries/timeseries.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("timeseries/timeseries.html",
    "<div class=\"card active\" ng-if=\"asset.timeseries\">\n" +
    "  <div class=\"card-content\">\n" +
    "\n" +
    "    <div class=\"timeseries-header-container\">\n" +
    ...
    "        <% asset.timeseries[0].location.name\n" +
    "          + ', '\n" +
    "          + asset.timeseries[0].parameter_referenced_unit.parameter_short_display_name %>\n" +
    "      </span>\n" +
    ...
    "\n" +
    "\n" +
    "    <div ng-if=\"content.timeseries.length\">\n" +
    "\n" +
    "      <br>\n" +
    "\n" +
    "      <div class=\"timeseries-graph-container\"\n" +
    "          ng-class=\"{hidden: !fullDetails}\"\n" +
    "          ng-if=\"content.timeseries[0].type === 'bar-chart'\">\n" +
    "         <graph\n" +
    "            bar-chart\n" +
    "            type=\"temporal\"\n" +
    "            temporal=\"timeState\"\n" +
...
angular.module("user-menu/user-menu.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("user-menu/user-menu.html",
    ...
    "  <div id=\"lizard-apps-container\" class=\"lizard-apps-container\"></div>\n" +
    "  <div class=\"container-fluid\">\n" +
    "    <ul class=\"nav navbar-nav navbar-left\">\n" +
    "      <li>\n" +
    "        <div id=\"lizard-apps-button\" class=\"lizard-apps-button\" title=\"Apps\"></div>\n" +
    "      </li>\n" +
