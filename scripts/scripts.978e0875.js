...
angular.module('templates-main', ['annotations/templates/annotations-make.html', 'annotations/templates/annotations-view.html', 'annotations/templates/annotations.html', 'dashboard/dashboard.html', 'data-menu/data-menu.html', 'graph/graph.html', 'layer-chooser/baselayer-chooser.html', 'layer-chooser/eventlayer-chooser.html', 'layer-chooser/layer-chooser.html', 'omnibox/templates/area.html', 'omnibox/templates/cardattributes.html', 'omnibox/templates/defaultpoint.html', 'omnibox/templates/empty.html', 'omnibox/templates/full-details.html', 'omnibox/templates/line.html', 'omnibox/templates/nestedasset.html', 'omnibox/templates/omnibox-dashboard.html', 'omnibox/templates/omnibox-search.html', 'omnibox/templates/point.html', 'omnibox/templates/rain.html', 'omnibox/templates/region.html', 'omnibox/templates/search-results.html', 'omnibox/templates/search.html', 'opacity/opacity.html', 'scenarios/scenarios.html', 'timeline/timeline.html', 'timeseries/timeseries.html', 'user-menu/user-menu.html']);
...
angular.module("annotations/templates/annotations-make.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("annotations/templates/annotations-make.html",
    ...
    "             type=\"file\" >\n" +
    "      <div\n" +
    "        ng-show=\"annotationform.attachment.$invalid\">\n" +
    "        <small\n" +
    "          class=\"text-danger\"\n" +
    "          ng-show=\"annotationform.attachment.$dirty && annotationform.attachment.$error.maxsize\"\n" +
    "          translate>\n" +
    ...
    "              ng-click=\"createAnnotation()\" translate>Add</button>\n" +
    "      <button class=\"btn btn-danger btn-sm\"\n" +
    "              ng-disabled=\"annotationform.$pristine\"\n" +
    "              ng-click=\"resetForm()\" translate>Clear</button>\n" +
    "    </form>\n" +
    "  </div>\n" +
    "</div>\n" +
    "");
...
angular.module("annotations/templates/annotations-view.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("annotations/templates/annotations-view.html",
    "<div class=\"annotations card active\" ng-if=\"annotations.length > 0\">\n" +
    "  <div class=\"card-content\">\n" +
    ...
    "          <td><% obj.text %></td>\n" +
    "          <td class=\"text-right\"><% obj.created_at | date : 'd MMM' %></td>\n" +
    "          <td class=\"text-right\">\n" +
    "            <a href=\"<% obj.picture_url %>\"\n" +
    "               title=\"<% 'Download attachment.'|translate %>\"\n" +
    "               ng-if=\"obj.picture_url\">\n" +
...
angular.module("data-menu/data-menu.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("data-menu/data-menu.html",
    ...
    "               class=\"button-list-link tooltip-left\"\n" +
    "               data-tooltip=\"<% 'Point selection' | translate %>\"\n" +
    ...
    "               class=\"button-list-link tooltip-left\"\n" +
    "               data-tooltip=\"<% 'Line selection' | translate %>\"\n" +
    ...
    "               class=\"button-list-link tooltip-left\"\n" +
    "               data-tooltip=\"<% 'Region selection' | translate %>\"\n" +
    ...
    "               class=\"button-list-link tooltip-left\"\n" +
    "               data-tooltip=\"<% 'View selection' | translate %>\"\n" +
...
angular.module("omnibox/templates/cardattributes.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("omnibox/templates/cardattributes.html",
    ...
    "          class=\"card-title-text kunstwerk-title-text\" translate>\n" +
...
angular.module("omnibox/templates/omnibox-dashboard.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("omnibox/templates/omnibox-dashboard.html",
    "<div>\n" +
    "</div>\n" +
    "");
}]);
...
angular.module("omnibox/templates/search.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("omnibox/templates/search.html",
    ...
    "    spellcheck=\"false\">\n" +
    "  <div\n" +
    "    data-tooltip=\"<% tooltips.resetQuery %>\"\n" +
    "    ng-click=\"cleanInput()\"\n" +
    "    id=\"clear\" class=\"clickable tooltip-bottom\" ></div>\n" +
    "  <div class=\"search-button-collection\">\n" +
    "    <a\n" +
    "      class=\"searchbutton clickable tooltip-bottom\"\n" +
    "      ng-click=\"zoomIn()\"\n" +
    "      aria-label=\"Zoom in\"\n" +
    "      data-tooltip=\"<% tooltips.zoomInMap %>\">\n" +
    ...
    "      ng-click=\"zoomOut()\"\n" +
    "      aria-label=\"Zoom uit\"\n" +
    "      data-tooltip=\"<% tooltips.zoomOutMap %>\">\n" +
...
angular.module("user-menu/user-menu.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("user-menu/user-menu.html",
    ...
    "       class=\"logout user tooltip-bottom\"\n" +
    ...
    "\n" +
    "    <a ng-if=\"!user.authenticated\"\n" +
    "       onclick=\"logIn()\" data-tooltip=\"<% tooltips.login %>\"\n" +
    "        class=\"clickable tooltip-bottom\" \n" +
    "       >\n" +
    ...
    "\n" +
    "  <nav>\n" +
    "    <a class=\"hidden-xs material-shadow tooltip-bottom\" ng-click=\"toggleDashboard()\" data-tooltip=\"<% 'Switch to ' + context | translate %>\" target=\"_blank\">\n" +
    "      <i class=\"fa fa-refresh\"></i>\n" +
    "    </a>\n" +
    "    <a class=\"hidden-xs material-shadow tooltip-bottom\" href=\"https://www.lizard.net/support\" data-tooltip=\"<% 'Question and manual' | translate %>\" target=\"_blank\">\n" +
