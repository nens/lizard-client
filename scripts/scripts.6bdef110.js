...
angular.module("export/export-selector.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("export/export-selector.html",
    ...
    "      You can select multiple timeseries to download. Once selected, press the\n" +
    "      <i>\"Start Export\"</i> button and the exporter will fetch the timeseries\n" +
    "      behind the scenes.\n" +
    "    </p>\n" +
    "    <p translate>\n" +
    ...
    "      </p>\n" +
    "    </div>\n" +
    "    <div ng-if=\"taskInfo.downloadUrl !== ''\">It is finished:\n" +
    "      <a ng-href=\"<% taskInfo.downloadUrl %>\" translate>Donwload\n" +
