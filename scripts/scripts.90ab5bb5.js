...
angular.module("omnibox/templates/rain.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("omnibox/templates/rain.html",
    ...
    "            <thead>\n" +
    "              <tr>\n" +
    "                <td class=\"larger-font-card-table\" translate>Start</th>\n" +
...
angular.module("omnibox/templates/timeseries.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("omnibox/templates/timeseries.html",
    ...
    "      ng-class=\"{hidden: !fullDetails}\"\n" +
    "    <!-- station_type = 1 is rain station; for now we only want rain station data as bars  -->\n" +
    "      ng-if=\"$parent.box.content.waterchain.layers.waterchain_grid.data.station_type === 1\">\n" +
    "     <graph\n" +
    "        bar-chart\n" +
    "        type=\"temporal\"\n" +
    "        temporal=\"timeState\"\n" +
...
angular.module("scenarios/scenarios.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("scenarios/scenarios.html",
    ...
    "        <h4 translate>3Di results</h4>\n" +
    "      </div>\n" +
    "   </div>\n" +
    "    <div class=\"row\">\n" +
    "      <div class=\"col-md-11 scenarios-inner\">\n" +
    "\n" +
    ...
    "              <td ng-click=\"select(scenario)\"><% scenario.name %> <a ng-click=\"preview(scenario)\"> (preview)</a></td>\n" +
    ...
    "                  </tr>\n" +
    "                </table>\n" +
    "                <span ng-if=\"scenario.result_set.length === 0\" translate>\n" +
    "                  No results\n" +
    "                </span>\n" +
    "              </td>\n" +
    "            </tr>\n" +
